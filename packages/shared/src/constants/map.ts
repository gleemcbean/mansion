...
export const ROOMS: ReadonlyArray<Room> = Object.freeze([
	...
	new Room("corridor", "Corridor")
		...
		.addLight(1.5, 1.6, 0.5, { intensity: 3 })
		.addLight(1.5, 1.6, 2.5, { intensity: 3 })
		.addLight(3.5, 1.6, 0.5, { intensity: 3 })
		.addLight(3.5, 1.6, 2.5, { intensity: 3 })
		.addLight(5.5, 1.6, 0.5, { intensity: 3 })
		.addLight(5.5, 1.6, 2.5, { intensity: 3 })
		.addLight(7.5, 1.6, 0.5, { intensity: 3 })
		.addLight(7.5, 1.6, 2.5, { intensity: 3 }),
