...
export class Logger {
  ...
  static debug(message: string, opts?: LogOptions) {
    console.debug(this.format("debug", message, opts));
  }

  static info(message: string, opts?: LogOptions) {
    console.info(this.format("info", message, opts));
  }

  static warn(message: string, opts?: LogOptions) {
    console.warn(this.format("warn", message, opts));
  }

  static error(message: string, opts?: LogOptions, err?: unknown) {
    console.error(this.format("error", message, opts));
