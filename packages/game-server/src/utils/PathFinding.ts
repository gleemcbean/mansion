 ...
 * Returns an array of world-space waypoints (cell centres), or null if unreachable.
 */
export function findPath(
  start: WorldPos,
  goal: WorldPos,
  cfg: GridConfig // ici on met bedroom1.json par exemple, juste le fichier avec la grille et les true/false
): WorldPos[] | null {
